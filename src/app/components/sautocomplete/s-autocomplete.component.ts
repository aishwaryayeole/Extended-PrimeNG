...
export const AUTOCOMPLETE_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => SAutocompleteWithChips),
  multi: true
};
...
@Component({
    ...
    template: `
        <span [ngClass]="{'ui-autocomplete ui-widget':true,'ui-autocomplete-dd':dropdown,'ui-autocomplete-multiple':multiple}" [ngStyle]="style" [class]="styleClass">
            ...
            [value]="value ? (field ? resolveFieldData(value)||value : value) : null" (input)="onInput($event)" (keydown)="onKeydown($event,inputtext)" (focus)="onFocus()" (blur)="onBlur()"
            ...
            <div class="ui-autocomplete-panel ui-widget-content ui-corner-all ui-shadow" [style.display]="panelVisible ? 'block' : 'none'" [style.width]="appendTo ? 'auto' : '100%'" [style.max-height]="scrollHeight">
                <ul class="ui-autocomplete-items ui-autocomplete-list ui-widget-content ui-widget ui-corner-all ui-helper-reset">
                    <li *ngFor="let option of suggestions" [ngClass]="{'ui-autocomplete-list-item ui-corner-all':true,'ui-state-highlight':(highlightOption==option)}"
                        ...
                        <span *ngIf="!itemTemplate">{{field ? option[field] : option}}12</span>
...
export class SAutocompleteWithChips implements AfterContentInit,AfterViewInit,DoCheck,AfterViewChecked,ControlValueAccessor {
...
@NgModule({
    ...
    exports: [SAutocompleteWithChips,InputTextModule,SharedModule],
    declarations: [SAutocompleteWithChips]
})
export class SAutocompleteWithChipsModule { }
